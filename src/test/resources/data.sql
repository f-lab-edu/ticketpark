...
values('CO', '2024 SM 통합콘서트', '고척돔', TIMESTAMPADD(DAY, 10, @fix_date), TIMESTAMPADD(DAY, 12, @fix_date), NOW());
...
values(TIMESTAMPADD(DAY, 3, @fix_date),TIMESTAMPADD(DAY, 10, @fix_date), now(), 1);
